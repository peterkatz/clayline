...
All 48 tile designs — SVG + preview PNG pairs — live in this one directory,
...
```sh
cd examples/gallery
python3 generate_tiles.py && python3 generate_variations.py && python3 generate_variations2.py && python3 generate_variations3.py
```
